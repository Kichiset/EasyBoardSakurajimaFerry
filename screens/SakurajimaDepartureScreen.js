  ...
  <SafeAreaView style={styles.safeArea}>
    <ScrollView contentContainerStyle={styles.container}>
      ...
      <View style={styles.kagoFrame}>
        ...
        onPress={() => {
          NextDept = nextDepartureSakurajima[0]
        ...
        onPress={() => {
          NextDept = nextDepartureSakurajima[1]
          //navigation.navigate('Notification',NextDept)
          props.navigation.navigate('Notification',NextDept,Port); // 遷移先の画面名を指定
          console.log(Port, NextDept);
          }}>
        ...
        style={[styles.button, styles.seletButton]}
        onPress={() => {
          NextDept = nextDepartureSakurajima[2]
          //navigation.navigate('Notification',NextDept)
          props.navigation.navigate('Notification',NextDept,Port); // 遷移先の画面名を指定
          console.log(Port, NextDept);
          }}>
        ...
        style={[styles.button, styles.seletButton]}
        onPress={() => {
          NextDept = nextDepartureSakurajima[3]
          //navigation.navigate('Notification',NextDept)
          props.navigation.navigate('Notification',NextDept,Port); // 遷移先の画面名を指定
          console.log(Port, NextDept);
          }}>
        ...
        style={[styles.button, styles.seletButton]}
        onPress={() => {
          NextDept = nextDepartureSakurajima[4]
          //navigation.navigate('Notification',NextDept)
          props.navigation.navigate('Notification',NextDept,Port); // 遷移先の画面名を指定
          console.log(Port, NextDept);
          }}>
        ...
        style={[styles.button, styles.seletButton]}
        onPress={() => {
          NextDept = nextDepartureSakurajima[5]
          //navigation.navigate('Notification',NextDept)
          props.navigation.navigate('Notification',NextDept,Port); // 遷移先の画面名を指定
          console.log(Port, NextDept);
          }}>
          ...
          <TouchableOpacity
            ...
            props.navigation.navigate('SakurajimaAll'); // 遷移先の画面名を指定
          }}>
